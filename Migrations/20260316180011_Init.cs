        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NguoiDaoTao = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LuongHopDong = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TrangThai = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recruitments_Departments_PhongBanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LeaveRequests_Employees_NguoiDuyetId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RewardDisciplines_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TangCa = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    ThucLanh = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    NgayTinhLuong = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NguoiTinhLuong = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrainingEmployees_Trainings_TrainingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_EmployeeId_Ngay",
                table: "Attendances",
                columns: new[] { "EmployeeId", "Ngay" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Departments_TruongPhongId",
                table: "Departments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_NguoiDuyetId",
                table: "LeaveRequests",
                column: "NguoiDuyetId");

            migrationBuilder.CreateIndex(
                name: "IX_Recruitments_PhongBanId",
                table: "Recruitments",
                column: "PhongBanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RewardDisciplines_EmployeeId",
                table: "RewardDisciplines",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Salaries_EmployeeId_Thang_Nam",
                table: "Salaries",
                columns: new[] { "EmployeeId", "Thang", "Nam" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingEmployees_TrainingId_EmployeeId",
                table: "TrainingEmployees",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Departments_Employees_TruongPhongId",
                table: "Departments",
                column: "TruongPhongId",
                principalTable: "Employees",
                principalColumn: "Id",
